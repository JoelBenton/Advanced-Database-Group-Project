...
interface CreateDoctorPageProps {
  onClose: () => void;
  addDoctor: (doctor: MedicalStaff) => void;
}
...
const CreateDoctorPage = ({ onClose, addDoctor }: CreateDoctorPageProps) => {
  ...
  return (
    <div className="p-6 bg-green-50 rounded-xl border-2 border-dashed border-green-300  w-full mx-auto space-y-6">
      <div>
